...
final_df <- read.csv(file.path('raw-csv', '4.S2_CDI_skills.csv'),
                     header=TRUE,
...
#save as CSV as finalraw for each one seperately, everything as been cleaned --------------
write.csv(merged_B_word, 
          file.path('raw-csv', '5.S2_CDI_FINALRAW.csv'),
          row.names=FALSE)
