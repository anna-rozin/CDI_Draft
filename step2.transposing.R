...
dat_S1 <- read.csv(file.path('raw-csv', '1.S1_CDI_nontransposed.csv'),
                header=TRUE,
                stringsAsFactors=FALSE)
dat_S2 <- read.csv(file.path('raw-csv', '1.S2_CDI_nontransposed.csv'),
                header=TRUE,
                stringsAsFactors=FALSE)
dat_B1 <- read.csv(file.path('raw-csv', '1.B1_CDI_nontransposed.csv'),
                header=TRUE,
                stringsAsFactors=FALSE)
dat_B2 <- read.csv(file.path('raw-csv', '1.B2_CDI_nontransposed.csv'),
                header=TRUE,
                stringsAsFactors=FALSE)
...
write.csv(final_df, 
          file.path('raw-csv', '2.merged_CDI_transposed.csv'),
          row.names=FALSE)
