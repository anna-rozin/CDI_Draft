...
#Load data of the transposed CDI's separately 
final_df <- read.csv(file.path('raw-csv', '2.S2_CDI_transposed.csv'),
                     header=TRUE,
...
#save each csv separately as cleaned.responses-----------

write.csv(final_df, 
          file.path('raw-csv', '3.S2_CDI_cleaned.responses.csv'),
          row.names=FALSE)
